...
data class NesPpuSnapshot(
    ...
    var frameCount: Int = 0,
    var memoryReadBuffer: Int = 0,
    var region: nes.cpu.ConsoleRegion = nes.cpu.ConsoleRegion.Ntsc,
    ...
    var outputBuffers: Array<IntArray> = Array(2) { IntArray(nes.console.NesConstants.ScreenPixelCount) },
) {
